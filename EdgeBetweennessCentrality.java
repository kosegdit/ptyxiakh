...
public class EdgeBetweennessCentrality {
    ...
    public List<Double> CalculateEdgeBetweenness(){
        ...
        for(int i=0; i<numOfEdges; i++){
            int n1 = parent.previewPanel.edges.get(i).node1.myListPosition();
            int n2 = parent.previewPanel.edges.get(i).node2.myListPosition();
    ...
    public void DisplayEdgeBetweenness(){
        ...
        for(int i=0; i<numOfEdges; i++){
            results[i][0] = parent.previewPanel.edges.get(i).label;
